<?php
	...
	$user = new User ();
	$app = new App("Chamar Próxima Senha - Controle de Atendimento","Chamar Próxima Senha - Controle de Atendimento",array('ADM','CASENHA','MATRICULA','MATRICULAGER'),$user);
	...
	if($_POST[p_O_Option] == 'insert')
	{
		...
		if($qtdSenha > 0)
		{
			...
			$proximaSenha = $caSenha->ProximaSenha($p_CAEvento_Id);
