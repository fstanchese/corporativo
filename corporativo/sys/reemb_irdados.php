<?php
	...
	$user = new User ();
	$app = new App("Reembolso - Geração de Planilha","Reembolso - Geração de Planilha",array('ADM','CPD'),$user);
		...
		$sql = "select
				...
				from 
  				...
  				where 
  					boleto.id = boleto_id 
  				and 
  					recebimento.dtpagto < '01/01/2015' 
  				and 
  					boleto.competencia >= '201501'
				and 
