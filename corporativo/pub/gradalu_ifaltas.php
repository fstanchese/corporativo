<?php
	...
	$user = new User ();
	$app = new App("Grade Curricular do Aluno - Consulta de Faltas - Portal","Grade Curricular do Aluno - Consulta de Faltas - Portal",array('ADM'),$user);
	...
	$js = "
			...
			{
				_ShowLoading();
				$('#div_'+vId).load('../ajax/gradalu_ialuno.ajax.php?vTipo=mostraFaltas&Matric_Id='+vIdr,function(){
					_HideLoading();
					$('#div_'+vId).show(1);
