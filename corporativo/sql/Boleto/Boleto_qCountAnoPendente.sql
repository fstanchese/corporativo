...
and
  ( 
    ...
    and
      BoletoTi_Id in (92200000000002,92200000000003,92200000000009,92200000000010,92200000000012)
    )
    or
    ( 
...
and
  referencia like '%' || p_O_AnoReferencia || '%' 
and
  p_O_AnoReferencia is not null
and
