  ...
  (
    (
      select 
        ...
        to_char(HoraProva.data,'dd/mm/yyyy HH24:mi') as Dia 
      from 
        disc,
        toxcd,
        curso,
      ...
      group by curso.id,toxcd.wpessoa_profresp_id,disc.codigo,horaprova.sala_id,to_char(HoraProva.data,'dd/mm/yyyy HH24:mi')
    )  
    union all
    ( 
      select 
