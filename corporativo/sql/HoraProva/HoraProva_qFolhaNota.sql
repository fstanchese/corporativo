(
  select
    ...
    CriAvalPDt_gsRecognize( p_CriAvalPDt_Id )                    as CriAvalPDt,
  ...
  from
    ...
    Curso
  where
    CurrXDisc.NotaTi_Id <> 12300000000004 
  and
  ...
  and
    ( 
      trunc(HoraProva.data) between p_HoraAula_DtInicio and p_HoraAula_DtTermino
        or
      p_HoraAula_DtInicio is null
        or
      p_HoraAula_DtTermino is null
    )
  and
