...
select
  ...
  nvl(matric.DTSTATE,matric.DATA)           as datarel,
  ...
  TurmaOfe_gsRetCodSala(Matric.TurmaOfe_id) as Sala_Recognize,
  Matric_gnEVestibulando(Matric.Id,CurrOfe.PLetivo_Id) as Vestibulando,
  matric.matricti_id
from
  matrictransf,
  pletivo,
...
select
  ...
  null,
  TurmaOfe_gsRetCodSala(Matric.TurmaOfe_id) as Sala_Recognize,
  Matric_gnEVestibulando(Matric.Id,DiscEsp.PLetivo_Id) as Vestibulando,
  matric.matricti_id
from
  pletivo,
  duracxci,
