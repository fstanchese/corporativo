...
and
  Bolsa.DtTermino = '31/12/2009'
and
  Bolsa.DtInicio = '01/01/2009'
and
  Bolsa.State_Id <> 3000000018002
and
  Bolsa.BolsaTi_Id = 10600000000129
and
  Bolsa.WPessoa_Id = WPessoa.Id 
and
  WPessoa.Id in (select WPessoa_Id from Vest where WPleito_Id = 7900000000019)
and
...
and
  Boleto.Referencia like '%2009/01'
and
