<?php
	...
	$user = new User ();
	$app = new App("Gerar Senha - Controle de Atendimento - Cobrança","Gerar Senha - Controle de Atendimento - Cobrança",array('ADM','MATRICULA','CASENHA'),$user);
					...
					$.colorbox(
						{
							...
							iframe: true,
							overlayClose:false,											 
							onClosed: function() { location.href='casenha_igeracaocob.php'; }
	...
	echo $view->Div(array("id"=>"201000000000098","class"=>"boxItem","style"=>"margin:1%;background:#084e8a;width:98%;align:center;","title"=>"Senha Normal")).
	$view->Strong("Senha Normal",array("style"=>"color:#fff;font-size:40px;")).
	$view->CloseDiv();
		

	echo $view->Div(array("id"=>"201000000000099","class"=>"boxItem","style"=>"margin:1%;background:#449de9;width:98%;align:center;","title"=>"Senha Preferencial")).
